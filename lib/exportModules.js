...
var appPost = require("././post");
var appAddInventory = require("././addInventory");
var appRemoveInventory = require("././removeInventory");
...
exports.config = function(name, user, pass) {
    if(name ==='inventory'){
        ...
        return appPost.config(user);
    }

    else if(name ==='addInventory'){
        return appAddInventory.config(user);
    }

    else if(name ==='removeInventory'){
        return appRemoveInventory.config(user);
    }
